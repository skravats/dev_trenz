...
module system_top (
  ...
  //ALT_IOBUF scl_iobuf (.i(1'b0), .oe(hdmi_i2c_scl_oe), .o(hdmi_i2c_scl_in), .io(hdmi_i2c_scl));
 // ALT_IOBUF sda_iobuf (.i(1'b0), .oe(hdmi_i2c_sda_oe), .o(hdmi_i2c_sda_in), .io(hdmi_i2c_sda));
  
  //assign hdmi_i2c_sda = hdmi_i2c_sda_oe? 1'b0 : 1'bz  ; 
  //assign hdmi_i2c_scl = hdmi_i2c_scl_oe? 1'b0 : 1'bz  ; 
  
  // hps_i2c2 routed to fmc via fpga io
  
  //wire              hps_i2c2_scl;
  //wire              hps_i2c2_scl_oe;
  //wire              hps_i2c2_sda;
  //wire              hps_i2c2_sda_oe;  

  //ALT_IOBUF scl_iobuf (.i(1'b0), .oe(hps_i2c2_scl_oe), .o(hps_i2c2_scl), .io(hdmi_i2c_scl));
  //ALT_IOBUF sda_iobuf (.i(1'b0), .oe(hps_i2c2_sda_oe), .o(hps_i2c2_sda), .io(hdmi_i2c_sda));
  ...
  ddr12 (
	.aclr(1'b0),
	.outclock(hdmi_clk),
	.datain_l({hdmi_red_i[7:4], hdmi_blu_i[7:4], hdmi_grn_i[7:4]}),
    .datain_h({hdmi_grn_i[3:0], hdmi_blu_i[3:0], hdmi_red_i[3:0]}),
 ...
 //   .sys_hps_i2c2_scl_in_clk (hps_i2c2_scl),
 //   .sys_hps_i2c2_clk_clk (hps_i2c2_scl_oe),
 //   .sys_hps_i2c2_sda (hps_i2c2_sda),
 //   .sys_hps_i2c2_out_data (hps_i2c2_sda_oe),	
	...
	//.hdmi_i2c_sda_in (hdmi_i2c_sda),
	//.hdmi_i2c_scl_in (hdmi_i2c_scl),
    ...
    .vga_out_data_vid_data ({hdmi_red_i, hdmi_grn_i, hdmi_blu_i}),
