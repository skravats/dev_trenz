...
proc compose { } {
    ...
    add_connection axi_spi_engine_0.spi_engine_ctrl spi_engine_interconnect_0.s1_ctrl conduit
    ...
    add_connection axi_spi_engine_0.spi_engine_offload_ctrl0 spi_engine_offload_0.spi_engine_offload_ctrl conduit
    ...
    add_connection axi_spi_engine_0.spi_resetn spi_engine_execution_0.resetn reset

    add_connection axi_spi_engine_0.spi_resetn spi_engine_interconnect_0.resetn reset

    add_connection axi_spi_engine_0.spi_resetn spi_engine_offload_0.spi_resetn reset

    add_connection axi_spi_engine_0.spi_resetn trigger_gen_0.rstn reset

    add_connection axi_spi_engine_0.spi_resetn upscale_converter_0.resetn reset

    add_connection dma_0.m_dest_axi sys_hps.f2h_sdram1_data avalon
    ...
    add_connection spi_engine_interconnect_0.m_ctrl spi_engine_execution_0.ctrl conduit
    ...
    add_connection spi_engine_offload_0.offload_sdi upscale_converter_0.s_axis conduit
    ...
    add_connection spi_engine_offload_0.spi_engine_ctrl spi_engine_interconnect_0.s0_ctrl conduit
    ...
    add_connection sys_clk.clk vga_pll.refclk clock

    add_connection sys_clk.clk_reset axi_spi_engine_0.s_axi_aresetn reset

    add_connection sys_clk.clk_reset dma_0.m_dest_axi_reset reset

    add_connection sys_clk.clk_reset dma_0.s_axi_reset reset
    ...
    add_connection sys_clk.clk_reset vga_out_data.is_clk_rst_reset reset

    add_connection sys_clk.clk_reset vga_pll.reset reset
    ...
    add_connection sys_hps.f2h_irq0 axi_spi_engine_0.irq interrupt
    set_connection_parameter_value sys_hps.f2h_irq0/axi_spi_engine_0.irq irqNumber {3}

    add_connection sys_hps.f2h_irq0 dma_0.interrupt_sender interrupt
    ...
    add_connection sys_hps.h2f_lw_axi_master dma_0.s_axi avalon
    ...
    add_connection sys_hps.h2f_lw_axi_master hdmi_i2c.csr avalon
    ...
    add_connection sys_hps.h2f_user1_clock axi_spi_engine_0.s_axi_aclk clock

    add_connection sys_hps.h2f_user1_clock dma_0.m_dest_axi_clock clock

    add_connection sys_hps.h2f_user1_clock dma_0.s_axi_clock clock

    add_connection trigger_gen_0.pulse spi_engine_offload_0.trigger conduit
    ...
    add_connection upscale_converter_0.m_axis dma_0.s_axis axi4stream

    add_connection vga_pll.outclk0 vga_out_clock.in_clk clock

    add_connection vga_pll.outclk0 vga_out_data.is_clk_rst clock

    add_connection vga_pll.outclk1 axi_spi_engine_0.spi_clk clock

    add_connection vga_pll.outclk1 dma_0.if_s_axis_aclk clock

    add_connection vga_pll.outclk1 spi_engine_execution_0.clk clock

    add_connection vga_pll.outclk1 spi_engine_interconnect_0.clk clock

    add_connection vga_pll.outclk1 spi_engine_offload_0.ctrl_clk clock

    add_connection vga_pll.outclk1 spi_engine_offload_0.spi_clk clock

    add_connection vga_pll.outclk1 trigger_gen_0.clk clock

    add_connection vga_pll.outclk1 upscale_converter_0.clk clock
